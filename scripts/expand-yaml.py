...
if __name__ == "__main__":
    ...
    for d in flight_dates:
        ...
        #
        f = p3data.flight_level["P3-{:02d}{:02d}".format(d.month,d.day)].to_dask()
        #
        ...
        mini_files = sorted(mini_dir.glob("*" + "{:04d}-{:02d}-{:02d}".format(d.year,d.month,d.day) + "*.yaml"))
        if len(mini_files) is 0:
            print ("Mini YAML file missing, skipping date " + "{:04d}-{:02d}-{:02d}".format(d.year,d.month,d.day))
        else:
            ...
            flight_yaml = p3_info
            flight_yaml.update({'flight_id': 'P3-{:02d}{:02d}'.format(d.month, d.day),
            ...
            output_name = seg_dir.joinpath("{}_{}_{}_{}".format(campaign, project, platform, variable) +
                                           "_{:04d}{:02d}{:02d}".format(d.year,d.month,d.day) + "_" + data_version + ".yaml")
